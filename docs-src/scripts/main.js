...
Object.keys(examples).forEach(exampleKey => {
    ...
    const buttonContainer = iframe.parentElement.querySelector('.playground-buttons');
...
window.addEventListener('message', (message) => {
    if (message.data.type === 'update-output' && examples[message.data.exampleKey] && message.data.outputContent) {
